...
Microsoft SQL Server (Igual que PostgreSQL)
SQL Server maneja los esquemas exactamente igual que PostgreSQL. Es el motor que más se le parece en este aspecto.

La estructura es: Servidor -> Base de Datos -> Esquema -> Tabla.

Dentro de una sola base de datos, puedes crear miles de esquemas (CREATE SCHEMA empresa_1;).

Puedes usar usuarios separados o un solo usuario administrador que se mueva entre esquemas. Al igual que en Postgres, puedes hacer consultas usando empresa_1.productos o configurar el contexto. No compromete la RAM.
